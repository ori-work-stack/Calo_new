      ...
      <View style={styles.contentSection}>
            ...
            >
              ...
              <View style={styles.macroCardContent}>
                ...
                <Text style={styles.macroCardLabel}>
                  {t("camera.results.nutrition")} · {t("camera.calories")}
                </Text>
              </View>
            </LinearGradient>
          </View>
          ...
          <View style={styles.macroCard}>
            ...
            >
              ...
              <View style={styles.macroCardContent}>
                ...
                <Text style={styles.macroCardLabel}>{t("camera.protein")}</Text>
              </View>
            </LinearGradient>
          </View>
          ...
          <View style={styles.macroCard}>
            ...
            >
              ...
              <View style={styles.macroCardContent}>
                ...
                <Text style={styles.macroCardLabel}>{t("camera.fat")}</Text>
              </View>
            </LinearGradient>
          </View>
        </View>
        ...
        <View style={styles.detailsSection}>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>{t("camera.carbs")}</Text>
            <Text style={styles.detailValue}>{nutrition.carbs}g</Text>
          </View>

          {nutrition.fiber > 0 && (
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>{t("camera.fiber")}</Text>
          ...
          {nutrition.sugar > 0 && (
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>{t("camera.sugar")}</Text>
          ...
          {nutrition.sodium > 0 && (
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>{t("camera.sodium")}</Text>
